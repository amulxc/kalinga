...
function Objectives() {
    ...
    return (
        <>
            {/* //change image */}
            <ImageListItem items={Items} imageSrc="https://kalinga-university.s3.ap-south-1.amazonaws.com/entrance-exam/entrance-1.webp" title="Objectives of New Raipur" description='' />
        </>
    )
}
