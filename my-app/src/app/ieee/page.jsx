...
const breadcrumbData = {
  heroImage: "https://kalinga-university.s3.ap-south-1.amazonaws.com/IEEE/IEEE(1).webp",
...
},
{
          ...
          <section className="w-full h-full container mx-auto  py-6">
           ...
           <AccreditationRanking 
                ...
                />
                    ...
                    <SectionHeading title={<>ESG & Sustainability Symposium
                      </>}
            titleClassName="text-center"
          /> 
                 {/* ================== UBA ACTIVITIES TABS ================== */}
            ...
            <TabsList className="!flex !gap-4 md:!gap-5 !bg-transparent !rounded-none !p-0 !overflow-x-auto !px-2 md:!px-0">
             ...
             <TabsTrigger
               value="22/11/2024 to 23/11/2024"
             ...
             <TabsTrigger
               value="22/11/2024 to 23/11/2024-ING"
             ...
             <TabsTrigger
               value="Poster / Project Presentation"
             ...
             >
              Valedictory Schedule
                     ...
                     <div className="mt-6 rounded-xl bg-white p-8">
                         ...
                         {/* TAB 1 */}
                         <TabsContent value="22/11/2024 to 23/11/2024">
  ...
  <tr>
    {/* DAY 1 COLUMN */}
    <td
      className="border border-gray-300 px-4 py-3 font-medium align-middle"
      rowSpan={8}
    >
      Day – 1<br />22-11-2024
    </td>
    ...
    <td className="border border-gray-300 px-4 py-3">
      Physical Registration & Check-in
    </td>

    {/* SINGLE VENUE COLUMN */}
    <td
      className="border border-gray-300 px-4 py-3 align-middle font-medium"
      rowSpan={15}
    >
  ...
  <tr>
    ...
    <td className="border border-gray-300 px-4 py-3">Visit to Champaran</td>
                         ...
                         <TabsContent value="22/11/2024 to 23/11/2024-ING">
                      {/* ================= VILLAGE / HOUSEHOLD SURVEY ================= */}
           <div className="space-y-6">
           ...
           <strong>
            Master of Ceremony: Dr. Anu G. Pillai</strong>
            <br></br>Timing: 10:30 AM to 11:15 AM
      ...
      <table className="w-full border-collapse text-left">
        ...
        <tbody className="bg-white">
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Welcome note by Master of Ceremony
            </td>
          ...
          <tr>
            <td className="border border-gray-300 px-4 py-3">
              10:35 AM to 10:38 AM
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Welcome of guests and address by Master of Ceremony
            </td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">
              10:38 AM to 10:40 AM
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Address by Honourable Chairman
            </td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">
              10:40 AM to 10:42 AM
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Address by Honourable Chancellor
            </td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">
              10:42 AM to 10:45 AM
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Address by Honourable Vice Chancellor
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Welcome note by Dr. Vijayalaxmi, Director IQAC
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Address by Respected Registrar
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              SDG – Logo Launching Ceremony and Inauguration of SDG Wall
              headed by Mrs. Saloni Tyagi, HoD Faculty of Law
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              High Tea
                         ...
                         {/* TAB 3 */}
                       {/* ================= TAB 3 ================= */}
<TabsContent value="Poster / Project Presentation">
  <div className="space-y-6">
...
<p>
  ...
  <br></br>
Date of Event: 22/11/2024, <br>
</br>Timing: 2:30 PM to 4:30 PM, Venue: Auditorium, Kalinga University
    ...
    <div className="overflow-x-auto rounded-xl border border-gray-300">
      <table className="w-full border-collapse text-left">
        ...
        <tbody className="bg-white">
          <tr>
            <td className="border border-gray-300 px-4 py-3">2:30 PM – 2:39 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-01</td>
            <td className="border border-gray-300 px-4 py-3">Kalinga University</td>
            <td className="border border-gray-300 px-4 py-3">
              Md Tawis Ansari, Sanjana Kumari, Komal Sahu, Md Aiman Shafi, Vinay Manikpuri
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">2:39 PM – 2:48 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-02</td>
            <td className="border border-gray-300 px-4 py-3">IIIT Naya Raipur</td>
            <td className="border border-gray-300 px-4 py-3">
              Nidhee Bhuwal, Chanchal Ijardar
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">2:48 PM – 2:57 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-03</td>
            <td className="border border-gray-300 px-4 py-3">Dr. C. V. Raman University</td>
            <td className="border border-gray-300 px-4 py-3">
              Mr. Ravish Gupta, Dr. Shikha Singh
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">2:57 PM – 3:06 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-04</td>
            <td className="border border-gray-300 px-4 py-3">Dr. C. V. Raman University</td>
            <td className="border border-gray-300 px-4 py-3">
              Dr. Ayaz Ahmed Faridi, Ravish Gupta, Adarsh Sharma
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:06 PM – 3:15 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-05</td>
            <td className="border border-gray-300 px-4 py-3">Dr. C. V. Raman University</td>
            <td className="border border-gray-300 px-4 py-3">
              Rajesh, Dr. Ragini Shukla
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:15 PM – 3:24 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-06</td>
            <td className="border border-gray-300 px-4 py-3">BIT Durg</td>
            <td className="border border-gray-300 px-4 py-3">
              Geetish Mahato, Anamika Dey
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:24 PM – 3:33 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-07</td>
            <td className="border border-gray-300 px-4 py-3">
              Guru Ghasidas University, Bilaspur
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Kumar Gulshan Raj, Aditya Raj, G Santhosh Nayak
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:33 PM – 3:42 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-08</td>
            <td className="border border-gray-300 px-4 py-3">IIIT Naya Raipur</td>
            <td className="border border-gray-300 px-4 py-3">
              Manjistha Bidkar, Alankar Saxena, Sanjana Sori
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:42 PM – 3:51 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-09</td>
            <td className="border border-gray-300 px-4 py-3">
              Guru Ghasidas University, Bilaspur
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Kishan Sahu, Rustam, Rohit Saijare, Mansee Singh
            </td>
            <td className="border border-gray-300 px-4 py-3">Online</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">3:51 PM – 4:00 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-10</td>
            <td className="border border-gray-300 px-4 py-3">SJMIT Chitradurga</td>
            <td className="border border-gray-300 px-4 py-3">
              Pallavi S A, Nikhitha P H, Manupriya P, Prof. Raghu S, Prof. Tanuja T
            </td>
            <td className="border border-gray-300 px-4 py-3">Online</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">4:00 PM – 4:09 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-11</td>
            <td className="border border-gray-300 px-4 py-3">IIIT Naya Raipur</td>
            <td className="border border-gray-300 px-4 py-3">
              Thampula Kartheek, Vaduguru Sai Venu Satya Ramlalith
            </td>
            <td className="border border-gray-300 px-4 py-3">Offline</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">4:09 PM – 4:18 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-12</td>
            <td className="border border-gray-300 px-4 py-3">SJMIT Chitradurga</td>
            <td className="border border-gray-300 px-4 py-3">
              Devika S, Divya B S, Hema B T, Purushotham T P, Sujith G R
            </td>
            <td className="border border-gray-300 px-4 py-3">Online</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">4:18 PM – 4:27 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-13</td>
            <td className="border border-gray-300 px-4 py-3">
              Guru Nanak Dev Engineering College, Bidar
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Kennath Jason, Abdul Aziz, Sheshank Sonji, Abhishek Patil
            </td>
            <td className="border border-gray-300 px-4 py-3">Online</td>
          </tr>

          <tr>
            <td className="border border-gray-300 px-4 py-3">4:27 PM – 4:35 PM</td>
            <td className="border border-gray-300 px-4 py-3">TEAM-14</td>
            <td className="border border-gray-300 px-4 py-3">
              Guru Ghasidas University, Bilaspur
            </td>
            <td className="border border-gray-300 px-4 py-3">
              Shrey Anant Sandiman, Nipun Kumar Mishra, Laxmikant Dewangan
            </td>
            <td className="border border-gray-300 px-4 py-3">Online</td>
          </tr>
        </tbody>
...
{/* ================= TAB 4 ================= */}
<TabsContent value="Valedictory Schedule">
  <div className="space-y-6">
    ...
    <div className="text-sm text-[var(--foreground)] leading-relaxed">
      ...
      <p><strong>Master of Ceremony: Dr. Anu G. Pillai</strong><br></br>
      Date:2/11/2024 to 23/11/2024<br></br>
      ...
      <table className="w-full border-collapse text-left">
        ...
        <tbody className="bg-white">
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Welcome of guests and address by the Master of the Ceremony
            </td>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Address by Mr. Rahul Pinnamaneni, Founder & CEO, Polygon
              Geospatial, Hyderabad
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Address by Mr. Abhinav Gambhir, Event Lead – IEEE CS SYP
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Concluding note by Dr. Vijayalaxmi, Director IQAC
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Certificates & Prize Distribution
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-3">
              Vote of Thanks by Dr. Anita Verma
            </td>
          </tr>
