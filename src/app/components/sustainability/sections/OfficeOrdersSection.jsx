...
/**
 * Office orders constituting the Centres of Excellence and the Sustainable
 * Standing Committee. Each order expands to its full text and links to the
 * signed PDF.
 */
export default function OfficeOrdersSection() {
    const [openId, setOpenId] = useState(OFFICE_ORDERS[0]?.id || null);

    return (
        <SectionBlock id="office-orders" title="Office Orders">
